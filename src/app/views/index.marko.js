...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/projnode$1.0.0/src/app/views/index.marko",
...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.produtos, function(produto) {
    ...
    out.w("<div class=\"card text-center \" style=\"border-color:20b2aa; width: 50rem;\"><img class=\"card-img-top text-center\"" +
      ...
      " </h3><h4 style=\"font-size:14px;\" id=\"id\">" +
      marko_escapeXml(produto.codPorduto) +
      " </h4><br><a href=\"/pagProduto\" class=\"btn\" style=\"background-color:20b2aa\">Mais informações</a><br><br><div class=\"card-footer bg-transparent \" style=\"font-size:20px;\">" +
...
marko_template.meta = {
    id: "/projnode$1.0.0/src/app/views/index.marko",
    tags: [
